...
function searchMyDataBase(){
	...
	//alert(tag);
	location.href = "${basePath}/movies_toMoviesList.html?query="+searchQuery;
}
</script>
<div class="header">
				<div class="logo">
					<a href="${basePath}/index.html"><h1>My Show</h1></a>
				</div>
				<div class="search">
					<div class="search2" style="display:inline;	float:left;width:100%">
					  <form id="search" action="${basePath}/movies_doSearch.html" method="post">
	...
	<div class="bootstrap_container">
            <nav class="navbar navbar-default w3_megamenu" role="navigation">
                <div class="navbar-header">
          			...
          			<a href="${basePath}/index.html" class="navbar-brand"><i class="fa fa-home"></i></a>
            ...
            <div id="defaultmenu" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown w3_megamenu-fw">
						<a href="${basePath}/movies_toMoviesList.html" class="active">影库</a>
                    </li>
                    <li class="dropdown w3_megamenu-fw">
